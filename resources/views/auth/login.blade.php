...
<html lang="es-ES">
	<head>
		...
		<title>Iniciar sesión - ACK</title>
								...
								<div class="col-md-6 col-lg-7 d-flex align-items-center">
									<div class="card-body p-4 p-lg-5 text-black">
										...
										<form method="POST" action="{{ route('login') }}">
											...
											<div class="form-floating mb-4">
												<input type="password" class="form-control" id="password" name="password" placeholder="Contraseña" value="" autocomplete="on" required>
												<label for="password">Contraseña</label>
                                            </div>
											
											<div class="d-grid gap-2 d-md-flex justify-content-md-end mb-4">
												<button class="btn btn-primary btn-lg btn-block w-100" type="submit">Iniciar sesión</button>
                                            </div>
										...
										<div class="text-center">
											<a href="{{ route('showRecoverPassword') }}" class="link-primary">¿Has olvidado la contraseña?</a>
										</div>
